...
export async function handleChat(request, clientRawRequest = null) {
  ...
  if (comboModels) {
    ...
    return handleComboChat({
      body,
      models: comboModels,
      handleSingleModel: (b, m) => handleSingleModelChat(b, m, clientRawRequest, request, apiKey, group),
      log,
      comboName: modelStr,
      comboStrategy,
      comboStickyLimit
  ...
  return handleSingleModelChat(body, modelStr, clientRawRequest, request, apiKey, group);
}

/**
 * Handle single model chat request
 */
async function handleSingleModelChat(body, modelStr, clientRawRequest = null, request = null, apiKey = null, group = null) {
  ...
  while (true) {
    const credentials = await getProviderCredentials(provider, excludeConnectionIds, model, { group });
